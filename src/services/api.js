...
const api = axios.create({
  baseURL: import.meta.env.VITE_API_URL || 'https://aum-backend-fhauchffh4cngxet.southeastasia-01.azurewebsites.net/api',
...
const FUNCTION_API_URL = 'https://aum-fillter-content-cmcrdxc4hvbnh5a4.southeastasia-01.azurewebsites.net/api';
